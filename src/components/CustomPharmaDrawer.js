...
const CustomPharmaDrawer = props => {
  return (
    <View style={styles.drawerBackground}>
      <View style={styles.ImageAndTextView}>
        ...
        <View style={styles.ProfileDataView}>
          <Text style={styles.VendorNameText}>Pharma Co. Name</Text>
          <Text style={styles.emailText}>pharmaCo@gmail.com</Text>
        </View>
      </View>
...
export default CustomPharmaDrawer;
